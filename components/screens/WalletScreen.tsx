    ...
    switch (period) {
      ...
      case "6M":
        return {
          ...
          data: [980, 1120, 1080, 1250, 1380, 1435.20]
        }
      case "1Y":
        return {
          labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
          data: [800, 850, 900, 950, 1000, 1050, 980, 1120, 1080, 1250, 1380, 1435.20]
        }
      default:
        return {
          labels: ["Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-2 mb-1">
                    <p className="text-gray-600 dark:text-gray-300 text-sm">Change in</p>
                    <select 
                    ...
                    >
                      {timePeriods.map((period) => (
                        <option key={period} value={period} className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
                          {period}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className="h-8 flex items-center">
                    <p className={`text-xl font-bold ${calculateChange(selectedPeriod) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                      {calculateChange(selectedPeriod) >= 0 ? '+' : ''}{calculateChange(selectedPeriod).toFixed(1)}%
                    </p>
                  </div>
                </div>
              </div>
